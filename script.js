        ...
        for (e of commands) {
            ...
            for (k of Object.values(e)[0]) {
                ...
                if (event.results[0][0].transcript.toLowerCase().includes(k)) {
                    ...
                    $("#initrec").hide();
                    $("#introtekst").hide();
                    $(".card-content").append("<span id='recbutton' class='dot waves-effect blue-grey darken-3 waves-light btn-large '><img class='micimage' src='Billeder/Startskaerm/MicrophoneWhite.png'></span>");
